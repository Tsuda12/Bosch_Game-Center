...
"")
        ...
        self.lbl_nome.setGeometry(QtCore.QRect(10, 60, 681, 31))
        font = QtGui.QFont()
...
"")
        ...
        self.lbl_nome_2.setGeometry(QtCore.QRect(15, 0, 681, 81))
        font = QtGui.QFont()
        font.setFamily("Montserrat Black")
...
"color: rgb(0, 255, 255);")
        ...
        self.img_forca.setGeometry(QtCore.QRect(182, 130, 131, 151))
        ...
        self.lbl_titulo_forca.setGeometry(QtCore.QRect(342, 140, 181, 31))
        font = QtGui.QFont()
...
"background-color: rgb(255, 85, 127);")
        ...
        self.lbl_descricao_forca.setGeometry(QtCore.QRect(342, 179, 221, 51))
        font = QtGui.QFont()
        ...
        self.btn_forca.setGeometry(QtCore.QRect(340, 240, 91, 30))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(10)
        font.setBold(True)
...
"color: black;")
        ...
        self.lbl_descricao_velha.setGeometry(QtCore.QRect(340, 369, 181, 51))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(12)
        ...
        self.btn_velha.setGeometry(QtCore.QRect(338, 430, 91, 30))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(10)
        font.setBold(True)
...
"color: black;")
        ...
        self.lbl_titulo_velha.setGeometry(QtCore.QRect(340, 330, 181, 31))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(10)
        font.setBold(True)
...
"background-color: rgb(255, 85, 127);")
        ...
        self.img_velha.setGeometry(QtCore.QRect(180, 320, 131, 151))
        ...
        self.img_ppt = QtWidgets.QLabel(self.menu_inicial)
        self.img_ppt.setGeometry(QtCore.QRect(182, 510, 131, 151))
        self.img_ppt.setText("")
        self.img_ppt.setPixmap(QtGui.QPixmap("img/jokenpo.png"))
        self.img_ppt.setScaledContents(False)
        self.img_ppt.setObjectName("img_ppt")
        self.lbl_titulo_ppt = QtWidgets.QLabel(self.menu_inicial)
        self.lbl_titulo_ppt.setGeometry(QtCore.QRect(342, 520, 181, 31))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.lbl_titulo_ppt.setFont(font)
        self.lbl_titulo_ppt.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(255, 85, 127);")
        self.lbl_titulo_ppt.setAlignment(QtCore.Qt.AlignCenter)
        self.lbl_titulo_ppt.setObjectName("lbl_titulo_ppt")
        self.lbl_descricao_ppt = QtWidgets.QLabel(self.menu_inicial)
        self.lbl_descricao_ppt.setGeometry(QtCore.QRect(342, 559, 191, 51))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(12)
        self.lbl_descricao_ppt.setFont(font)
        self.lbl_descricao_ppt.setStyleSheet("color: rgb(255, 255, 255);")
        self.lbl_descricao_ppt.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.lbl_descricao_ppt.setObjectName("lbl_descricao_ppt")
        self.btn_ppt = QtWidgets.QPushButton(self.menu_inicial)
        self.btn_ppt.setGeometry(QtCore.QRect(340, 620, 91, 30))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.btn_ppt.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btn_ppt.setStyleSheet("background-color: rgb(85, 255, 255);\n"
"color: black;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_titulo_forca.setText(_translate("MainWindow", "<html><head/><body><p>FORCA</p></body></html>"))
        ...
        self.lbl_titulo_velha.setText(_translate("MainWindow", "<html><head/><body><p>VELHA</p></body></html>"))
        self.lbl_titulo_ppt.setText(_translate("MainWindow", "<html><head/><body><p>JOKEN PO</p></body></html>"))
        self.lbl_descricao_ppt.setText(_translate("MainWindow", "<html><head/><body><p>Acerte o objeto certo<br/>e vença.</p></body></html>"))
        self.btn_ppt.setText(_translate("MainWindow", "JOGAR"))
